...
export default function ProjectSlider() {
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 1366, // Cover larger laptop screens
        settings: {
          slidesToShow: 2,
          autoplay: false,
        },
  ...
  return (
    <div className="lg:p-5 rounded-xl">
      <div className="container max-w-[1344px] px-5 mx-auto">
        ...
        <Slider {...settings} className="relative">
          {projects.map((project, index) => (
            <div
              key={index}
              className="col-span-1 flex flex-col gap-3 h-auto justify-between p-3 lg:p-5"
            >
              <div className="w-full h-[200px] lg:h-[300px] relative">
                <Image
                  src={project.imgSrc}
              ...
              <h1 className="font-bold text-sm lg:text-md font-syne2 text-[#222222] lg:text-xl mb-4">
                {project.title}
              </h1>
            </div>
          ))}

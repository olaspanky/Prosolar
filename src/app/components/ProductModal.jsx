...
const ProductModal = ({ product, onClose }) => {
  ...
  // Extract form data from the Zoho form
  const form = e.target;
  const formData = {
    name: form.querySelector('#Last_Name').value, // Map 'Last Name' to 'name'
    email: form.querySelector('#Email').value,    // Map 'Email' to 'email'
    phone: form.querySelector('#Mobile').value,   // Map 'Mobile' to 'phone'
    location: form.querySelector('#City').value,  // Map 'City' to 'location'
  };
  ...
  acceptCharset="UTF-8"
  onSubmit={handleZohoSubmit} // Use handleZohoSubmit here
>
  {/* Form fields */}
  <div className="mb-4">
  ...
  <div className="flex gap-2">
    ...
    <button type="reset" className="bg-gray-500 text-white px-4 py-2 rounded">
      Reset
    </button>
  </div>
</form>

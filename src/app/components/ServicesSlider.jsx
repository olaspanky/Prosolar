...
export default function SliderComponent({ title, description, slides, settings }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row p-2 lg:p-10 bg-gray-100 rounded-lg">
      <div className="container max-w-[1344px] mx-auto flex flex-col lg:flex-row lg:p-10">
        ...
        {/* Right Side Slider */}
        <div className="lg:w-1/2 mt-10 lg:mt-0 lg:ml-10 bg-white p-12 rounded-lg shadow-md relative">

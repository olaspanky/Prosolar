...
const Hero = ({ scrollToHero }) => {
  ...
  <div className='w-full h- auto px-5 '>
    <div className='bg-lbg bg-cover bg-center lg:h-[50vh] flex flex-col gap-5 lg:gap-9 justify-center items-center p-5 xl:p-20 2xl:p-36 rounded-xl'>
<h1 className='text-md lg:text-xl xl:text-7xl text-center font-bold text-black '>95kWp Solar Power Plant</h1>

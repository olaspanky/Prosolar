  ...
  return (
    <div className="xl:px-12  xl:py-36 p-3 text-black">
      ...
      <div className="bg-[#F9F9F9] p-9 rounded-xl">
        <h1 className="text-5xl text-yellow-300 text-center my-5">Why Choose Us</h1>
        <div className="lg:grid grid-cols-2 gap-3 ">
          ...
          <div className="col-span-1 flex flex-col justify-center items-center gap-9 p-3 xl:p-20 my-20">
            <div className="flex flex-col gap-2">
              <h1 className="font-bold text-xl">Cut Costs with ProSolar</h1>
              <p className="text-lg">
            ...
            <div className="flex flex-col gap-2">
              <h1 className="font-bold text-xl">After Sales Services</h1>
              <p className="text-lg">
      ...
      <div className=" p-5 rounded-xl">
        <h1 className="text-5xl text-[#292ECF] text-center my-5">How it Works</h1>
        <div className="lg:grid grid-cols-2 gap-3 ">
          <div className="col-span-1 flex flex-col gap-3 lg:gap-20 p-3 lg:p-20">
            ...
            <div className="flex gap-5">
                ...
                <div className="flex flex-col gap-3">
                <h1 className="font-bold text-xl">Energy Audit</h1>
                <p className="text-lg">
                We guarantee customers full product support services, covering
                all operational stages, from installation to commissioning,
                training and long-term maintenance and repair.
      ...
      <div className=" p-5 rounded-xl">
        <h1 className="text-5xl text-[#292ECF] text-center my-5">Some of our past projects</h1>
        <div className="lg:grid grid-cols-3 gap-5 ">
          <div className="col-span-1 flex flex-col gap-3 p-3 lg:p-5">
          <Image src={p1} className="w-full"/>
          <h1 className="font-bold lg:text-xl">Project one</h1>
          <p className="text-lg">
...
<h2 className="testimonial-title text-center text-5xl text-white my-5">Voice of Confidence,<br/>
